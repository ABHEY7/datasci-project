...
#---------------------------------------------------------------------------------------------------------
        ...
        self.heading2 = Label(self.root, text ='Step4- Visualisation',fg='#c62f42',bg='#1b2d2d', font = ('Sans-Serif', 21, 'bold'))
        self.heading2.place(x=200,y=320)
...
#---------------------------------------------------------------------------------------------------------
        ...
        self.button3=Button(self.root,text='Q1-Top 10 Expected Population Countries for the year 2050',bg='#1b2d2d',fg='#c62f42',font=('Cooper Black',11),anchor='w',command=lambda: self.q1('pop2050'))
        self.button3.place(x=60,y=375,width=500,height=30)
       
        
        self.button3=Button(self.root,text='Q2-  TOP 10 countries Area-wise',bg='#1b2d2d',fg='#c62f42',font=('Cooper Black',11),anchor='w',command=lambda: self.q1('area'))
        self.button3.place(x=60,y=425,width=500,height=30)
        self.button3=Button(self.root,text='Q3-  TOP 10 countries with Highest growthRate',bg='#1b2d2d',fg='#c62f42',font=('Cooper Black',11),anchor='w',command=lambda: self.q1('growthRate'))
        self.button3.place(x=60,y=475,width=500,height=30)
        self.button3=Button(self.root,text='Q4-  TOP 10 countries with Highest population',bg='#1b2d2d',fg='#c62f42',font=('Cooper Black',11),anchor='w',command=lambda: self.q1('pop2023'))
        self.button3.place(x=60,y=525,width=500,height=30)
    
        self.button3=Button(self.root,text='Q5-Compression Between Waterarea and Landarea  ',bg='#1b2d2d',fg='#c62f42',font=('Cooper Black',11),anchor='w')
        self.button3.place(x=60,y=575,width=500,height=30)
...
#---------------------------------------------------------------------------------------------------------
        ...
        self.frame3=Frame(self.root,width=350,height=370,bg='white')
    ...
    def q1(self, froms):
        ...
        if froms == 'pop2023':
            ...
            if 'pop2023' in self.df.columns:
                ...
                l=list(self.df.country.values[:10])
                o=list(self.df.pop2023.values[:10])
                print(o)
                plt.pie(o,labels=l)
            else:
                messagebox.showerror('Alert', 'Not sufficient data.' )
